...
static VIDEO_START( segajw )
{

}

static SCREEN_UPDATE( segajw )
{
	return 0;
}
...
static MACHINE_START( segajw )
{

}


static MACHINE_RESET( segajw )
{
}
...
static MACHINE_CONFIG_START( segajw, segajw_state )
	...
	MCFG_MACHINE_START(segajw)
	MCFG_MACHINE_RESET(segajw)
	...
	MCFG_SCREEN_UPDATE(segajw)

	MCFG_PALETTE_INIT(segajw)
	MCFG_PALETTE_LENGTH(16)

	MCFG_VIDEO_START(segajw)
