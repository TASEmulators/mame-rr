...
local profile = {
	...
	},
	{
		...
		player = 0xFF8388, 
		text = {
			life  = {offset = 0x042, max = 144, pos_X = 0x14, pos_Y = 0x0A, color = color.text.life},
			super = {offset = 0x1D4, max =  80, pos_X = 0x94, pos_Y = 0xD4, color = color.text.super, 
				align = "align outer"},
		},
	...
	},
	{
		...
		text = {
			life  = {offset = 0x042, max = 144, pos_X = 0x12, pos_Y = 0x0E, color = color.text.life},
			super = {offset = 0x1D4, max = 112, pos_X = 0x0E, pos_Y = 0x34, color = color.text.super, 
				align = "align outer"},
		},
		show_OSD = function() return any_true({
			rd(0xFF8004) == 0x40000 and bit.band(rd(0xFF8008), 0x8FFFF) == 0x80000,
	...
	},
	{
		...
		player = 0xFF8400, 
		text = {
			life  = {max = 144, pos_X = 0x20, pos_Y = 0x08, color = color.text.life, 
				val = function(p) return rw(p.base + 0x052)%144 end},
			super = {offset = 0x10A, max = 144, pos_X = 0x06, pos_Y = 0xD8, color = color.text.super, 
				align = "align outer"},
			dark_force = {offset = 0x176, max = 112, pos_X = 0x60, pos_Y = 0x20, color = color.text.guard, 
	...
	},
	{
		...
		text = {
			...
			dark_force_change = {offset = 0x176, max = 112, pos_X = 0x60, pos_Y = 0x08, align = "align outer", 
				color = color.text.guard, condition = function(p) return rb(p.base + 0x110) > 0 end},
			dark_force_power = {offset = 0x1C4, max = 112, pos_X = 0x60, pos_Y = 0x20, 
				color = color.text.super, condition = function(p) return rw(p.base + 0x1C2) > 0 end},
		},
		show_OSD = function() return rw(0xFFF000) == 0x0101 end,
	},
	{
		...
		text = {
			life  = {offset = 0x040, max = 144, pos_X = 0x10, pos_Y = 0x0A, color = color.text.life},
			super = {offset = 0x0BE, max = 144, pos_X = 0x1C, pos_Y = 0xD8, color = color.text.super},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0xFF8400, nplayers = 3, 
		text = {
			life  = {offset = 0x050, max = 144, pos_X = 0x20, pos_Y = 0x0A, color = color.text.life},
			super = {offset = 0x09E, max = 144, pos_X = 0x1C, pos_Y = 0xD8, color = color.text.super, 
	...
	},
	{
		...
		text = {
			life  = {offset = 0x050, max = 144, pos_X = 0x84, pos_Y = 0x08, color = color.text.life},
			super = {offset = 0x11E, max = 144, pos_X = 0x66, pos_Y = 0xCA, color = color.text.super, 
		...
		special = function(p)
			if not (rb(p.base + 0x15E) > 0 or player[3].active or player[4].active) then
				p.text.guard = {X = 0x28, Y = 0x1A, color = color.text.guard}
			...
			if rb(p.base + 0x102) == 0x1C then
				p.text.claw = {X = 0, Y = 0xB8, color = color.text.item, val = "-", align = "align outer"}
				...
				p.text.mask = {X = 0, Y = 0xC0, color = color.text.item, val = "-", align = "align outer"}
	...
	},
	{
		...
		player = 0xFF8000,
		text = {
			life = {offset = 0x02C, max = 278, pos_X = 0x4, pos_Y = 0x30, color = color.text.life, 
				align = "align outer"},
		},
		stun_bar = {
		...
		special = function(p)
			...
			p.bar.rage_level = {X = 0x18, Y = 0xCC, length = 0x80, height = 0x04, color = color.bar.stun_level, 
			...
			if rw(p.base + 0xB0) == 1 then
				p.bar.rage_timeout.color = color.bar.stun_duration
				...
				p.bar.rage_timeout.color = color.bar.stun_timeout
	...
	},
	{
		...
		player = 0xFF81A0,
		text = {
			life  = {offset = 0x044, max = 152, pos_X = 0xA2, pos_Y = 0x18, color = color.text.life},
			super = {offset = 0x394, max =  63, pos_X = 0x88, pos_Y = 0xD6, color = color.text.super, 
				read = rb, align = "align outer"},
			boost = {offset = 0x16A, max =  29, pos_X = 0xA2, pos_Y = 0x20, color = color.text.gaurd, read = rb},
			arm   = {offset = 0x16C, max =  48, pos_X = 0x3C, pos_Y = 0x10, color = color.text.item, read = rb},
	...
	},
	{
		...
		player = 0xFF8400,
		text = {
			life  = {offset = 0x040, max = 144, pos_X = 0x00, pos_Y = 0x20, color = color.text.life, 
				align = "align outer"},
			super = {offset = 0x195, max =  96, pos_X = 0x2E, pos_Y = 0x28, color = color.text.super, 
				read = rb, align = "align outer"},
			red    = {offset = 0x1A2, max = 96, pos_X = 0x98, pos_Y = 0xD8, color = color.text.guard},
			yellow = {offset = 0x1A4, max = 96, pos_X = 0x60, pos_Y = 0xD8, color = color.text.guard},
			blue   = {offset = 0x1A6, max = 96, pos_X = 0x28, pos_Y = 0xD8, color = color.text.guard},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0xFF4000,
		text = {
			life  = {offset = 0x190, max = 143, pos_X = 0x24, pos_Y = 0x00, color = color.text.life, 
				align = "align outer"},
			super = {offset = 0x194, max = 142, pos_X = 0x24, pos_Y = 0x08, color = color.text.super, 
				align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0xFF4000,
		text = {
			life  = {offset = 0x190, max = 144, pos_X = 0x04, pos_Y = 0x00, color = color.text.life, 
				align = "align outer"},
			super = {offset = 0x194, max = 144, pos_X = 0x04, pos_Y = 0x08, color = color.text.super,
				align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0xFF4000,
		text = {
			life  = {offset = 0x210, max = 144, pos_X = 0x04, pos_Y = 0x04, color = color.text.life,
				align = "align outer"},
			super = {offset = 0x212, max = 144, pos_X = 0x0C, pos_Y = 0xD8, color = color.text.super,
				align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		text = {
			life  = {offset = 0x250, max = 144, pos_X = 0x04, pos_Y = 0x22, color = color.text.life, 
				align = "align outer"},
			super = {offset = 0x252, max = 144, pos_X = 0x10, pos_Y = 0xD8, color = color.text.super},
		},
		stun_bar = {
			pos_X = 0x18, pos_Y = 0x24, length = 0x40, height = 0x04, 
			level = function(p)
	...
	},
	{
		...
		text = {
			life  = {offset = 0x270, max = 144, pos_X = 0x04, pos_Y = 0x06, color = color.text.life,
				align = "align outer"},
			super = {offset = 0x272, max = 144, pos_X = 0x20, pos_Y = 0xCA, color = color.text.super, 
				align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		text = {
			life  = {offset = 0x120, max = 207, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			super = {offset = 0x118, max = 127, pos_X = 0x5C, pos_Y = 0xD6, color = color.text.super, 
				align = "align outer"},
			super_timeout = {offset = 0x150, max = 600, pos_X = 0x5C, pos_Y = 0xCE, color = color.text.item,
	...
	},
	{
		...
		text = {
			life  = {offset = 0x120, max = 207, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			super = {offset = 0x118, max = 127, pos_X = 0x6C, pos_Y = 0xD6, color = color.text.super, 
				align = "align outer"},
			super_timeout = {offset = 0x150, max = 900, pos_X = 0x6C, pos_Y = 0xCE, color = color.text.item,
				condition = function(p) return rw(p.base + 0x118) == 127 end, align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0x108100, space = 0x200, 
		text = {
			life  = {offset = 0x138, max = 103, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 103, pos_X = 0x38, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, max = 128, pos_X = 0x64, pos_Y = 0xD6, color = color.text.super, 
				read = rb, align = "align outer"},
			super_timeout = {offset = 0x0EA, max = 64, pos_X = 0x64, pos_Y = 0xCE, color = color.text.item,
	...
	},
	{
		...
		text = {
			life  = {offset = 0x138, max = 103, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 103, pos_X = 0x38, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, max = 128, pos_X = 0x6C, pos_Y = 0xD6, color = color.text.super, 
				read = rb, align = "align outer"},
			super_timeout = {offset = 0x0EA, max = 64, pos_X = 0x6C, pos_Y = 0xC4, color = color.text.item,
				condition = function(p) return rw(p.base + 0x0EA) > 0 end, read = rb, align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		text = {
			life  = {offset = 0x138, max = 103, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 103, pos_X = 0x38, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, pos_X = 0x6C, pos_Y = 0xD6, color = color.text.super, 
				max = function(p)
	...
	},
	{
		...
		player = 0x108100, space = 0x200, 
		text = {
			life  = {offset = 0x138, max = 101, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 101, pos_X = 0x38, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, max = 144, pos_X = 0x4C, pos_Y = 0x30, color = color.text.super, read = rb},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0x108100, space = 0x200, 
		text = {
			life  = {offset = 0x138, max = 102, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 102, pos_X = 0x38, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, max = 144, pos_X = 0x4C, pos_Y = 0x30, color = color.text.super, read = rb},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0x108100, space = 0x200, 
		text = {
			life  = {offset = 0x138, max = 102, pos_X = 0x14, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 102, pos_X = 0x3C, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, max = 078, pos_X = 0x28, pos_Y = 0xD8, color = color.text.super, read = rb},
		},
		show_OSD = function()
	...
	},
	{
		...
		text = {
			life  = {offset = 0x138, max = 102, pos_X = 0x10, pos_Y = 0x00, color = color.text.life},
			guard = {offset = 0x146, max = 102, pos_X = 0x38, pos_Y = 0x00, color = color.text.guard},
			super = {offset = 0x0E8, max = 066, pos_X = 0x6C, pos_Y = 0xD2, color = color.text.super, 
				read = rb, align = "align outer"},
			super_timeout = {offset = 0x0EA, max = 47, pos_X = 0x6C, pos_Y = 0xCA, color = color.text.item,
				condition = function(p) return rw(p.base + 0x0EA) > 0 end, read = rb, align = "align outer"},
		},
		show_OSD = function()
			return bit.band(rb(0x10A7D6), 0x80) == 0 and rb(0x10A7D8) > 0 and bit.band(rb(0x10A788), 0x02) == 0
	...
	},
	{
		...
		text = {
			life  = {offset = 0xB9, max = 96, pos_X = 0x02, pos_Y = 0x18, color = color.text.life, 
				read = rb, align = "align outer"},
		},
	...
	},
	{
		...
		text = {
			life  = {offset = 0xCA, max = 96, pos_X = 0x8A, pos_Y = 0x10, color = color.text.life},
		},
		stun_bar = {
	...
	},
	{
		...
		text = {
			life  = {offset = 0x9A, max = 96, pos_X = 0x8A, pos_Y = 0x10, color = color.text.life, read = rb},
		},
		stun_bar = {
			pos_X = 0x50, pos_Y = 0x24, length = 0x40, height = 0x04, align = "align outer", 
	...
	},
	{
		...
		player = 0x100400, space = 0x100, 
		text = {
			life  = {offset = 0x89, max = 120, pos_X = 0x08, pos_Y = 0x20, color = color.text.life, 
				read = rb, align = "align outer"},
		},
		stun_bar = {
	...
	},
	{
		...
		player = 0x100400, space = 0x100, 
		text = {
			life  = {offset = 0x89, max = 192, pos_X = 0x14, pos_Y = 0x28, color = color.text.life, 
				read = rb, align = "align outer"},
			super = {offset = 0xBA, max =  60, pos_X = 0x8A, pos_Y = 0xD0, color = color.text.super, read = rb},
		},
		stun_bar = {
			pos_X = 0x50, pos_Y = 0x2A, length = 0x40, height = 0x04, align = "align outer", 
			level = function(p) return rb(p.base + 0x90), rb(p.base + 0x91) end,
	...
	},
	{
		...
		player = 0x100400, space = 0x100, 
		text = {
			life  = {offset = 0x8B, max = 192, pos_X = 0x14, pos_Y = 0x28, color = color.text.life, 
				read = rb, align = "align outer"},
			super = {offset = 0xBC, max =  60, pos_X = 0x8A, pos_Y = 0xD0, color = color.text.super, read = rb},
		},
		show_OSD = function()
			return any_true({
	...
	},
	{
		...
		player = 0x100400, space = 0x100, 
		text = {
			life  = {offset = 0x8E, max = 120, pos_X = 0x14, pos_Y = 0x08, color = color.text.life, read = rb},
			super = {offset = 0xBE, max = 128, pos_X = 0x5C, pos_Y = 0xD0, color = color.text.super, 
				read = rb, align = "align outer"},
			guard = {pos_X = 0x44, pos_Y = 0x08, color = color.text.guard, 
...
for _, g in ipairs(profile) do
	if string.find(g.games[1], "sf2") then
		g.text = {
			life  = {offset = 0x2A, max = 144, pos_X = 0x10, pos_Y = 0x0E, color = color.text.life,
				condition = function(p) return g.show_life() end},
			super = {offset = 0x2B4, max = 48, pos_X = 0x48, pos_Y = 0xCE, color = color.text.super, 
		...
		g.special = function(p)
			if rb(p.base + game.offset.char_id) == 0xB then
				p.text.claw = {X = 0, Y = 0xD8, color = color.text.item, val = "-", align = "align outer"}
	...
	for _, text in pairs(g.text or {}) do
		...
		if type(m) == "number" then
			text.max = function() return m end
		end
...
local get_char_data = function(p)
	for _, text in pairs(game.text or {}) do
		if text.condition(p) then
			local data = {X = text.pos_X, Y = text.pos_Y, color = text.color, 
				align = text.align, val = text.val(p), max = text.max(p)}
	...
	p.bar.stun_level = {X = game.stun_bar.pos_X, Y = game.stun_bar.pos_Y, 
		...
		data = p.text.stun_level, align = game.stun_bar.align, color = color.bar.stun_level}
	...
	if p.state == "countdown" then
		p.bar.stun_timeout.color = color.bar.stun_duration
	elseif p.state == "grace" then
		p.bar.stun_timeout.color = color.bar.stun_grace
	else
		p.bar.stun_timeout.color = color.bar.stun_timeout
	end
...
local draw_stun = function(p)
	local f, s, b = color.STUN.fill, color.STUN.shade, color.STUN.outline
...
local draw_player_objects = function(p)
	if show_bars then
		for _, bar in pairs(p.bar) do
			gui.box(bar.bg_inner, bar.top, bar.bg_outer, bar.bottom, color.bar.bg.fill, color.bar.bg.outline)
